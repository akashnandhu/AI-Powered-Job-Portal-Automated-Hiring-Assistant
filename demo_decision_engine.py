...
def main():
    print("--- Running Automated Hiring Decision Engine Demo ---")
    ...
    candidate_2 = UnifiedCandidateScore(
        ...
        risk_tag="YELLOW", # Moderate risk overrides strong score
    ...
    candidate_3 = UnifiedCandidateScore(
        ...
        final_hiring_fit_score=45.0, # Score capped due to RED risk
    ...
    for idx, candidate in enumerate(candidates, 1):
        ...
        results.append(decision_result.to_dict())
        
    import os
    os.makedirs("output", exist_ok=True)
    output_path = "output/decision_outputs.json"
    with open(output_path, "w") as f:
        json.dump(results, f, indent=4)
        
    print(f"\nSuccessfully saved automated hiring decisions to {output_path}")
